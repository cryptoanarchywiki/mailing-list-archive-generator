...
+ Return to "[Cereal Killer <wheaties<span>@</span>dev.null>](/authors/cereal_killer_wheaties_at_dev_null_)"
...
+ Return to "[Geraint Price <Geraint.Price<span>@</span>cl.cam.ac.uk>](/authors/geraint_price_geraint_price_at_cl_cam_ac_uk_)"
...
+ Return to "["Marcus J. Ranum" <mjr<span>@</span>nfr.net>](/authors/marcus_j_ranum_mjr_at_nfr_net_)"
+ Return to "[Mark Armbrust <marka<span>@</span>ff.com>](/authors/mark_armbrust_marka_at_ff_com_)"
+ Return to "["Marty Levy" <rwww60<span>@</span>email.sps.mot.com>](/authors/marty_levy_rwww60_at_email_sps_mot_com_)"
+ Return to "["Matt Crawford" <crawdad<span>@</span>fnal.gov>](/authors/matt_crawford_crawdad_at_fnal_gov_)"
+ Return to "[Phil Karn <karn<span>@</span>homer.ka9q.ampr.org>](/authors/phil_karn_karn_at_homer_ka9q_ampr_org_)"
