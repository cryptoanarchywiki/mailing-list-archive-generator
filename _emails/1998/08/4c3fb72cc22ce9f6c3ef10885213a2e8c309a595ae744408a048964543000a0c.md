...
# 1998-08-23 - Subject: PLEEEEEEEZ   READ

## Header Data

From: Carol \<anyuser<span>@</span>anyuser.com\><br>
To: \<cstanley@direct.ca\><br>
Message Hash: 4c3fb72cc22ce9f6c3ef10885213a2e8c309a595ae744408a048964543000a0c<br>
Message ID: \<18161.236028.18680579 dave@menconi.com\><br>
Reply To: _N/A_<br>
UTC Datetime: 1998-08-23 18:18:09 UTC<br>
Raw Date: Sun, 23 Aug 1998 11:18:09 -0700 (PDT)<br>

## Raw message

```
{% raw  %}From: Carol <anyuser@anyuser.com>
Date: Sun, 23 Aug 1998 11:18:09 -0700 (PDT)
To: <cstanley@direct.ca>
Subject: Subject: PLEEEEEEEZ   READ
Message-ID: <18161.236028.18680579 dave@menconi.com>
MIME-Version: 1.0
...
First, I'd like to tell you to REALLY read this and REALLY give it some thought 
before you say, "it doesn't work". It works. But you have to follow it and do 
everything just like it says. Read through this a couple of times to fully understand 
how it works.  Once you get the hang of it, it's easy.  If you need extra cash it's worth 
it.
...
of us, but I was curious, so I kept reading. Anyway, it said that you send
...
catch, that was it. The main difference between this system and others

is that you have a mailing list of 6 instead of 5... This means that

your average gain will be app. 15 times higher!!!
...
another thought. But the money just kept coming in. In my first week, I

made about $20.00 to $30.00 dollars. By the end of the second week I had
...
made a total of just over $42,000.00 and it's still coming in rapidly.......
...
can get the information off of it as you need it. The process is very

simple and consists of 3 easy steps:



STEP 1: Get 6 separate pieces of paper and write the following on each

piece of paper "PLEASE PUT ME ON YOUR MAILING LIST" (include your name 
and address). Now get 6 US$1.00
...
envelope to prevent thievery. Next, place one 

paper in each of the 6 envelopes and seal them. You should now have 6
...
a service by this. THIS IS ABSOLUTELY LEGAL!
...
4876 Princess Ann Rd # 118  
Box 319
Va Beach, Virginia, 23462
...
least 200 newsgroups. (I think there is close to 24,000 groups) All you
...
#1 position, move everyone up a spot (re-number everyone elses
...
entitled 'Window' select 'NetscapeNews'. Then from the pull down

menu 'Options', select 'Show all Newsgroups'. After a few moments

a list of all the newsgroups on your server will show up. Click

on any newsgroup you desire. From within this newsgroup, click on

the 'TO NEWS' button, which should be in the top left corner of

the newsgroups page. This will bring up a message box.
...
Step 6. Highlight the entire contents of your .txt file and copy

them using the same technique as before. Go back to the newsgroup
...
Step 7. Hit the 'Send' Button in the upper left corner. You're
...
give it a try? Estimates are at 20,000

to 50,000 new users, every day, with thousands of those joining the
...
+ Return to "[Carol <anyuser<span>@</span>anyuser.com>](/authors/carol_anyuser_at_anyuser_com_)"

+ 1998-08-23 (Sun, 23 Aug 1998 11:18:09 -0700 (PDT)) - Subject: PLEEEEEEEZ   READ - _Carol \<anyuser@anyuser.com\>_
