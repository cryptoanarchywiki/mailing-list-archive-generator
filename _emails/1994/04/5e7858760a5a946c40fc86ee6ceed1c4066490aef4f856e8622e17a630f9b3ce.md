...
# 1994-04-18 - Fenced DES

## Header Data

From: ritter<span>@</span>IO.COM (ritter)<br>
To: cypherpunks@toad.com<br>
Message Hash: 5e7858760a5a946c40fc86ee6ceed1c4066490aef4f856e8622e17a630f9b3ce<br>
Message ID: \<199404180344.WAA17369@indial1.IO.COM\><br>
Reply To: _N/A_<br>
UTC Datetime: 1994-04-18 03:49:04 UTC<br>
Raw Date: Sun, 17 Apr 94 20:49:04 PDT<br>

## Raw message

```
{% raw  %}From: ritter@IO.COM (ritter)
Date: Sun, 17 Apr 94 20:49:04 PDT
To: cypherpunks@toad.com
Subject: Fenced DES
Message-ID: <199404180344.WAA17369@indial1.IO.COM>
MIME-Version: 1.0
Content-Type: text
...
+ Return to "[ritter<span>@</span>IO.COM (ritter)](/authors/ritter_at_io_com_ritter_)"

+ 1994-04-18 (Sun, 17 Apr 94 20:49:04 PDT) - Fenced DES - _ritter@IO.COM (ritter)_
