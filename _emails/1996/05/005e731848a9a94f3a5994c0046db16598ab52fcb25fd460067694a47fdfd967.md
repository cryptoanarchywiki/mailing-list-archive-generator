...
From: "nCognito Remailer \<nobody<span>@</span>foo.bar.net\>" \<nobody<span>@</span>foo.bar.net\><br>
...
+ Return to "["nCognito Remailer <nobody<span>@</span>foo.bar.net>" <nobody<span>@</span>foo.bar.net>](/authors/ncognito_remailer_nobody_at_foo_bar_net__nobody_at_foo_bar_net_)"
