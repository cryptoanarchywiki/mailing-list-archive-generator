...
From: Olivier GALIBERT \<Olivier.Galibert<span>@</span>mines.u-nancy.fr\><br>
...
+ Return to "[Arve Kjoelen <akjoele<span>@</span>ee.siue.edu>](/authors/arve_kjoelen_akjoele_at_ee_siue_edu_)"
+ Return to "[Olivier GALIBERT <Olivier.Galibert<span>@</span>mines.u-nancy.fr>](/authors/olivier_galibert_olivier_galibert_at_mines_unancy_fr_)"
