...
# (Unknown Date) - Re: Why Doesn't Wired.....

## Header Data

From: jimp<span>@</span>wired.com (Jim Petersen)<br>
To: werewolf@io.org (Mark Terka)<br>
Message Hash: c3626a60e619aaa282083532124fcc084fee02b9b72ae4435c7e42f42f086863<br>
Message ID: \<4d08848dffcdbd0f7a5839bb1547e3d4@NO-ID-FOUND.mhonarc.org\><br>
Reply To: \<v4cAlOwscUg6077yn@io.org\><br>
...
```
{% raw  %}From: jimp@wired.com (Jim Petersen)
...
+ Return to "[jimp<span>@</span>wired.com (Jim Petersen)](/authors/jimp_at_wired_com_jim_petersen_)"

+ _Unknown thread root_
  + (Unknown Date) (None) - Re: Why Doesn't Wired..... - _jimp@wired.com (Jim Petersen)_
