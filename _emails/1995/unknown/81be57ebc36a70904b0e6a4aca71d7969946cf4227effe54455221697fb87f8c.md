...
From: david<span>@</span>arch.ping.dk (David Stodolsky)<br>
To: _N/A_<br>
Message Hash: 81be57ebc36a70904b0e6a4aca71d7969946cf4227effe54455221697fb87f8c<br>
Message ID: \<e55da1ebf2506d48b87733fd40dd6e96@NO-ID-FOUND.mhonarc.org\><br>
Reply To: _N/A_<br>
...
```
{% raw  %}From: david@arch.ping.dk (David Stodolsky)
...
+ Return to "[david<span>@</span>arch.ping.dk (David Stodolsky)](/authors/david_at_arch_ping_dk_david_stodolsky_)"

+ (Unknown Date) (None) - No Subject - _david@arch.ping.dk (David Stodolsky)_
